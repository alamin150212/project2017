...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2017 at 07:11 AM
...
INSERT INTO `tbl_course` (`ID`, `CourseNo`, `Title`, `Credit`, `CourseTypeID`, `DisciplineID`) VALUES
('{1D0C80CA-27D0-4D39-9243-61D711D5D1EE}', 'ECE 3251', 'Data Com', 3, '{E97F9EEF-E8DC-40DE-B125-158C62469A71}', '{B34A0580-0B92-49BD-84FB-929297B104C5}'),
('{20A7D69C-84DD-4902-AFA3-6302F5E38D5B}', 'CSE 4102', 'Graphics', 3, '{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}'),
('{2159A611-485C-4229-A836-4305A0D745F2}', 'CSE 3202', 'Com', 3, '{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}'),
('{51C152F8-0A18-4383-926E-312AB3F35FF3}', 'CSE 4102', 'Graphics', 3, '{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}'),
('{79AA0AB1-76F6-48C4-886C-7B75975F87CA}', 'CSE 4247', 'Information Security', 3, '{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}'),
('{B4C9EDF6-3D3F-40D8-8C5A-6F6851AECC4C}', 'CSE 3221', 'Web Programing Laboratory', 1.5, '{E97F9EEF-E8DC-40DE-B125-158C62469A71}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}'),
('{D6CAA64B-F9D0-4FAE-BEF7-FAB98CE010BF}', 'CSE 4223', 'Datamining', 3, '{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', '{FFDB1CB8-AF34-4381-8971-9784DCB516C5}');
...
('{C9E33083-05DB-4B4F-9001-8B7A1865A1C7}', 'Theory', ''),
('{E97F9EEF-E8DC-40DE-B125-158C62469A71}', 'Sessional', '');
...
('{F0DC8142-2936-4216-B7D2-3FEB06053BA2}', 'FWT'),
...
('1', 'asdf'),
('2', '8-8.50'),
('{40D63F8D-986A-4783-A117-C5CA70A8A729}', 'hh'),
('{48006C8D-6178-4157-98E1-A8618DCC262F}', 'hkjhjh');
...
CREATE TABLE `tbl_routine` (
  ...
  `DayName` varchar(40) NOT NULL,
  `TeacherName` varchar(40) NOT NULL,
  `SlotNo` varchar(40) NOT NULL,
...
INSERT INTO `tbl_routine` (`ID`, `TermName`, `DayName`, `TeacherName`, `SlotNo`, `CourseName`, `Discipline`) VALUES
('{225B7BD6-5C19-4631-AEE5-67C234687B65}', 'B.Sc 8th', 'Sunday', 'Md.Mohudul Alam', '3', 'CSE 4223', 'Computer Science and Engineering'),
('{2A9FD23D-3DAC-466B-9981-B9BDC4BEC7A0}', 'B.Sc 7th', 'Sunday', 'Dr. Rafiqul Islam', '6', 'CSE 4102', 'Computer Science and Engineering'),
('{3AB1C463-ECA2-4B92-91C8-CB32E5DF014A}', 'B.Sc 6th', 'Sunday', 'Md.Masudul Alam', '5', 'ECE 3251', 'Computer Science and Engineering'),
('{634ECCF9-2C52-47CF-83A3-9DC487C46ED2}', 'B.Sc 8th', 'Sunday', 'Dr. Rafiqul Islam', '4', 'CSE 4247', 'Computer Science and Engineering'),
('{FAADD05E-F942-4816-BF8B-E074CE41678A}', 'B.Sc 6th', 'Sunday', 'Dr. Rafiqul Islam', '1', 'CSE 3221', 'Computer Science and Engineering');
...
INSERT INTO `tbl_routine_day` (`ID`, `Name`) VALUES
('1', 'Sunday'),
('2', 'Monday'),
('3', 'Tuesday'),
('4', 'Wednesday'),
...
CREATE TABLE `tbl_teacher` (
  ...
  `DiscplineName` varchar(255) NOT NULL
...
INSERT INTO `tbl_teacher` (`ID`, `Name`, `Email`, `DiscplineName`) VALUES
('{DBB9F19A-9A3B-4ADB-813C-96C7D6593D8D}', 'Md.Mohudul Alam', 'mahudul@gmail.com', 'Computer Science and Engineering'),
('{848E0482-52D3-4386-AB82-D9D67A440AA1}', 'Md.Masudul Alam', 'mkazi@ac.bd', 'Computer Science and Engineering'),
('{E3EC810E-79D7-4810-8892-223F53051296}', 'Dr. Rafiqul Islam', 'rafiqul@gmail.com', 'Computer Science and Engineering');
