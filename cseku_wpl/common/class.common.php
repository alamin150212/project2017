...
class CourseType{
    ...
    public function setsessionalID ($sessionalID){
        $this->_sessionalID = $sessionalID;
    }
    public function getsessionalID(){
...
class Teacher{
    ...
    public function setDiscplineName ($DiscplineName){
        $this->_DiscplineName = $DiscplineName;
    }
    public function getDiscplineName(){
        return $this->_DiscplineName;
    }
}
