...
class PermissionUtil{
    ...
    public static $ROUTINE_MANAGE_C='ROUTINE_MANAGE_C';
    public static $ROUTINE_MANAGE_R='ROUTINE_MANAGE_R';
    public static $ROUTINE_MANAGE_U='ROUTINE_MANAGE_U';
    public static $ROUTINE_MANAGE_D='ROUTINE_MANAGE_D';

    public static $ROUTINE_C='ROUTINE_C';
    public static $ROUTINE_R='ROUTINE_R';
    public static $ROUTINE_U='ROUTINE_U';
    public static $ROUTINE_D='ROUTINE_D';
...
class PageUtil{
    ...
    public static $ROUTINE='routine.php';
    public static $ROUTINE_MANAGE='routine_manage.php';
...
class RouteUtil{
   ...
   private function __construct(){
        ...
        //add new page and routing address here always
         ...
         self::$s_Routes[PageUtil::$ROUTINE]  = "modules/routine/ui/view.routine.php";
         self::$s_Routes[PageUtil::$ROUTINE_MANAGE]  = "modules/routine/ui/view.routineManage.php";
...
class MiddlewareUtil{
    ...
    private function __construct(){
        ...
        //example: login.php should be successfully logged in to get to home.php
         ...
         self::$s_Routes[PageUtil::$ROUTINE_MANAGE]   =  PageUtil::$LOGIN ;
         self::$s_Routes[PageUtil::$ROUTINE]   =  PageUtil::$LOGIN ;
