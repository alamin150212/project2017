...
Class RoutineManageDAO{
    ...
    public function getAllRoutine(){
        ...
        $this->_DB->doQuery("SELECT * FROM rms_routine order by year_id");
    ...
    public function createRoutineAnotherUser($Routine){
        ...
        $RoutineCourse=$Routine->getRoutineCourseId();
        $RoutineUser=$Routine->getRoutineUserId();
        $RoutineAnotherUser=$Routine->getRoutineAnotherUserId();
        $RoutineDay=$Routine->getRoutineDayId();
        $RoutineTime=$Routine->getRoutineTime();


        $SQL = "INSERT INTO rms_routine(id,year_id,term_id,course_id,user_id,another_user,day_id,time_id) 
                VALUES('$RoutineId','$RoutineYear','$RoutineTerm','$RoutineCourse','$RoutineUser','$RoutineAnotherUser','$RoutineDay','$RoutineTime')";
