...
class Routine{
    ...
    //Another UserId
    public function getRoutineAnotherUserId(){
        return $this->_routineAnotherUserId;
    }

    public function setRoutineAnotherUserId($routineUserId){
        $this->_routineAnotherUserId=$routineUserId;
    }
